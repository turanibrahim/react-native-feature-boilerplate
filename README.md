...
<a href='https://reactnativeelements.com/'><img src='https://user-images.githubusercontent.com/5962998/65694309-a825f000-e043-11e9-8382-db0dba0851e3.png' height='110' alt='React Native Elements' /></a>

<a href='https://github.com/immerjs/immer'><img src='https://github.com/immerjs/immer/blob/master/images/immer-logo.svg' height='110' alt='Immer.js'/></a>
  ...
  - `/features` - Config files
    - `login`- Each folder will be a feature like this.
      ...
      - `/redux`
        ...
        - `actions` - Actions that mutates reducers states
        - `thunkActions` - async actions
        - `selectors` - reducer data filter functions
        - `types` - reducer/action types
...
1. Clone this repo, `git clone https://github.com/turanibrahim/react-native-feature-boilerplate.git <your project name>`
